...
//    var googleApiKey = "AIzaSyAD54OHhYoN8oKkVT4DpDwsz7Vi4SdeE-A"
//
...
//            return;
//        } else {
//            var urlString = getUrl(api, input: covertedInput)
//            print("Google api request - \(urlString)")
//            urlString = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?key=AIzaSyAD54OHhYoN8oKkVT4DpDwsz7Vi4SdeE-A&location=40.7128 , -74.0060&radius=500&type=&type=restaurant&keyword=burrito"
