...
// MARK:- Google API Helper (Provided by Ray Wenderlich) with minor changes to performance
...
class GoogleDataProvider {
  ...
  private var session: URLSession {
    ...
    func fetchPlacesNearCoordinate(_ coordinate: CLLocationCoordinate2D, radius: Double, types:[String], keyword: String, completion: @escaping PlacesCompletion) -> Void {
